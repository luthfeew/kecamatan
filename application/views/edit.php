                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="card">
                                                                                              ...
                                                                                              <form action="<?php echo form_open('dashboard/updatee/'.$hasil->id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                                                                        ...
                                                                                                        <div class="row form-group">
                                                                                                            ...
                                                                                                            <div class="col-12 col-md-9">
                                                                                                                <input type="text" id="text-input" name="judulberita" placeholder="Text" class="form-control" value="<?php echo $hasil->judulberita ?>">
                                                                                                        ...
                                                                                                        <div class="row form-group">
                                                                                                            ...
                                                                                                            <div class="col-12 col-md-9">
                                                                                                                <textarea name="isiberita" id="textarea-input" rows="9" placeholder="Content..." class="form-control"><?php echo $hasil->isiberita ?></textarea>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="row form-group">
                                                                                                            <div class="col col-md-3">
                                                                                                        ...
                                                                                                        <input class="btn btn-success" type="reset" name="btn" value="Save" />
                                                                                                    </form>
