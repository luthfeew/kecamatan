                                        ...
                                        <tbody>
                                          ...
                                          foreach ($berita as $row) {
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc"><?php echo substr($row->judulberita, 0, 20)  ?>...</td>

                                                <td>
                                                    <img src="<?php echo base_url()?>assets/images/<?php echo $row->gambar ?>" width="200" height="100" />
                                                </td>

                                                <td><?php echo substr($row->isiberita, 0, 50)  ?> ...</td>

                                                <td><?php echo $row->tanggalupload ?></td>
                                                
                                                <td>
                                                    <div class="table-data-feature">
                                                       <a href="<?php echo base_url();?>index.php/dashboard/updatee/<?php echo $row->id ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
